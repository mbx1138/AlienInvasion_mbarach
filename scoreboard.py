...
class Scoreboard:
    ...
    def __init__(self, ai_game):
        ...
        self.font = pygame.font.Font(
            "Assets/Fonts/Silkscreen/Merriweather_24pt-ExtraBold.ttf", 30
            )
    ...
    def prep_score(self):
        ...
        self.score_rect.centerx = self.screen_rect.centerx + 100
    ...
    def prep_level(self):
        ...
        # Position the level to left of high score.
        self.level_rect = self.level_image.get_rect()
        self.level_rect.left = 285
